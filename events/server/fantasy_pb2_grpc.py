...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in fantasy_pb2_grpc.py depends on'
...
class FantasySubscriberStub(object):
...
def add_FantasySubscriberServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'fantasy.FantasySubscriber', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('fantasy.FantasySubscriber', rpc_method_handlers)


 # This class is part of an EXPERIMENTAL API.
class FantasySubscriber(object):
    """Missing associated documentation comment in .proto file."""
